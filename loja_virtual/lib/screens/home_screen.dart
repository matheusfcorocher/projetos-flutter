...
import 'package:lojavirtual/tabs/products_table.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PageView(
      ...
      children: <Widget>[
       //As crianças do PageView será cada tab do aplicativo
        Scaffold(
          body: HomeTab(),
          drawer: CustomDrawer(_pageController),
          //Vai aparece o botao flutuando no canto direito da tela
